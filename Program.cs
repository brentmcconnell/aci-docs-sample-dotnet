namespace aci_doc_sample_dotnet
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string containerImageApp     = "mcr.microsoft.com/azuredocs/aci-helloworld";
            string containerImageSidecar = "mcr.microsoft.com/azuredocs/aci-tutorial-sidecar";
            string taskContainerImage    = "mcr.microsoft.com/azuredocs/aci-wordcount";
            ...
            Console.WriteLine($"\nPress ENTER to to update Task container...");
            Console.ReadLine();
            RunTaskBasedContainer2(azure, resourceGroupName, taskContainerGroupName, taskContainerImage, null);
        ...
        private static void RunTaskBasedContainer2(IAzure azure,
                                                 string resourceGroupName, 
                                                 string containerGroupName, 
                                                 string containerImage,
